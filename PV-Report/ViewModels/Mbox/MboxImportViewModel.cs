...
namespace PvReport.ViewModels.Mbox
{
    public class MboxImportViewModel : DependencyObject
    {
        ...
        public MboxImportViewModel()
        {
            _allEmails = new List<SolarWebReportEmail>();
            MboxFilePath = Path.Combine(Directory.GetCurrentDirectory(), "Test", "PV Report.mbox");

            OpenMboxFileCommand = new Command<object>(OnOpenMboxFileCommandExecute);
            ParseMboxFileCommand = new Command<object>(OnParseMboxFileCommandExecute);
        }

        private void OnParseMboxFileCommandExecute(object o)
        {
        ...
        private void OnOpenMboxFileCommandExecute(object o)
        {
        ...
        public ICommand OpenMboxFileCommand { get; }
        public ICommand ParseMboxFileCommand { get; }
